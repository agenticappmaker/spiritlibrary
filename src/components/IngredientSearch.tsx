...
const synonymGroups: string[][] = [
  ...
  ['orange juice', 'orange', 'fresh orange juice', 'oj'],
  ['grapefruit juice', 'grapefruit', 'fresh grapefruit juice', 'pink grapefruit juice'],
  ['pineapple juice', 'pineapple', 'fresh pineapple juice'],
  ['passionfruit', 'passion fruit', 'passion fruit juice', 'passionfruit juice', 'passion fruit purée', 'passion fruit syrup'],
  ['cranberry juice', 'cranberry', 'cranberries'],
  ...
  ['club soda', 'soda water', 'sparkling water', 'seltzer', 'carbonated water', 'soda'],
  ['cola', 'coke', 'coca-cola', 'pepsi', 'coca cola'],
  ['lemon lime soda', 'sprite', '7up', '7-up', 'sierra mist', 'lemon-lime soda'],
  ...
  ['watermelon', 'watermelon juice', 'fresh watermelon juice'],
  ['mango', 'mango purée', 'mango juice'],
  ['cucumber', 'cucumbers'],
  ['mint', 'fresh mint', 'fresh mint leaves', 'mint leaves'],
